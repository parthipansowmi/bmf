...
export const apiport = process.env.PORT || 3002;
export const apihost = process.env.WEBSITE_HOSTNAME || `localhost:${apiport}`;
...
export const  SMSmessage = process.env.sms_message || 'Thank you for booking the event';
