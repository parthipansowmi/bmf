  ...
  babelHelpers.createClass(Statement, [{
    ...
    value: function bind() {
      ...
      return new this.Promise(function (resolve, reject) {
        ...
        (_stmt = _this.stmt).bind.apply(_stmt, params.concat([function (err) {
          if (err) {
            reject(err);
          } else {
            resolve(_this);
    ...
    value: function run() {
      ...
      return new this.Promise(function (resolve, reject) {
        ...
        (_stmt2 = _this4.stmt).run.apply(_stmt2, params.concat([function (err) {
          if (err) {
            reject(err);
          } else {
            resolve(_this4);
    ...
    value: function get() {
      ...
      return new this.Promise(function (resolve, reject) {
        ...
        (_stmt3 = _this5.stmt).get.apply(_stmt3, params.concat([function (err) {
          if (err) {
            reject(err);
          } else {
            resolve(_this5);
    ...
    value: function all() {
      ...
      return new this.Promise(function (resolve, reject) {
        ...
        (_stmt4 = _this6.stmt).all.apply(_stmt4, params.concat([function (err) {
          if (err) {
            reject(err);
          } else {
            resolve(_this6);
    ...
    value: function each() {
      ...
      return new this.Promise(function (resolve, reject) {
        ...
        (_stmt5 = _this7.stmt).each.apply(_stmt5, params.concat([callback, function (err) {
...
var Database = function () {
  ...
  babelHelpers.createClass(Database, [{
    ...
    value: function run(sql) {
      ...
      return new this.Promise(function (resolve, reject) {
        _this2.driver.run(sql, params || [], function (err) {
          if (err) {
            reject(err);
          } else {
            resolve(_this2);
    ...
    value: function each(sql) {
      ...
      var callback = params.pop();
      return new this.Promise(function (resolve) {
        _this6.driver.each(sql, params, callback, resolve);
      });
    }
  }, {
    key: 'prepare',
    value: function prepare(sql) {
      ...
      return new this.Promise(function (resolve, reject) {
        ...
        var stmt = (_driver = _this7.driver).prepare.apply(_driver, [sql].concat(params, [function (err) {
          if (err) {
            reject(err);
          } else {
    ...
    value: function () {
      var ref = babelHelpers.asyncToGenerator(regeneratorRuntime.mark(function _callee() {
        ...
        var _ref2$table = _ref2.table;
        var table = _ref2$table === undefined ? 'migrations' : _ref2$table;
        var _ref2$migrationsPath = _ref2.migrationsPath;
        var migrationsPath = _ref2$migrationsPath === undefined ? './migrations' : _ref2$migrationsPath;
